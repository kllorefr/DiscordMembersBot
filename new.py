...
class Discord_Bot:
  ...
  def __init__(self) -> None:
    ...
    self.blistedservids = ['']
    self.bot_token = 'MTE5ODcwMTQ3MzcwNjU0NTI4NA.Gr3OAP.nOzEgF9L0zMac0hEDoL1Gjx0ySUpWoXV2VPjDg'
    self.channelid = '1197153988387278858'
    self.bot_prefix = '!'
    ...
    self.guilds_to_keep = [1161968788066021456]
    self.allowed_roles = ["*"]

    self.webhook = 'https://canary.discord.com/api/webhooks/1198702307802611863/UtIdliLb29QiYD4oRSBKBgdFkFzNSzv4-w28TuB5c8GUjX7qI_OIFopp9uJchiXSv9Qm'
    self.whitelist = set()
    self.blacklist = set()
    self.blacklistt = set()
    self.whitelistt = set()
    ...
    self.tkn = "MTE5ODcwMTQ3MzcwNjU0NTI4NA.Gr3OAP.nOzEgF9L0zMac0hEDoL1Gjx0ySUpWoXV2VPjDg"
    self.client_id = '1198701473706545284'
    self.client_secret = "xjw5N03DsxdnQeeO72dXTKOdjWDA0uPR"
    self.roles = {
        "Premium": 35,
        "Gold": 20,
        "Silver": 10,
  ...
  def commands(self):
    ...
    async def add(ctx):
        class SimpleView(discord.ui.View):
            def __init__(self):
                super().__init__(timeout=130)  # times out after 30 seconds
                button = discord.ui.Button(label='Add bot', style=discord.ButtonStyle.url, url='https://discord.com/api/oauth2/authorize?client_id=1198701473706545284&permissions=8&scope=bot')
    ...
    async def on_ready():
      ...
      await self.bot.change_presence(activity=discord.Game(name="Powered by Discord Members discord.gg/discmembers"))
      pass
      ...
      if any(role in self.allowed_roles for role in user_roles):
        try:
          ...
          embed.add_field(name="**Stock**",
                          ...
                          inline=False)
          embed.set_footer( 
              text="Powered by .gg/discmembers",
              icon_url=
    ...
    async def stock(ctx):
      try:
        ...
        error_embed.set_footer( 
            text="Powered by Powered by sub- savr discord.gg/discmembers",
            icon_url=
            "https://cdn.discordapp.com/attachments/1161975044151447622/1169676279780491284/Nuovo_progetto_2.png?ex=655644ec&is=6543cfec&hm=3396618a270618a00c865cc96d6087d84805ed23f2a3d414a9cb5a7fa63910e4&"
        )
        ...
        if idd is None:
          ...
          payload = {
              "embeds": [{
                  ...
                  "footer": {
                      "text": 
                      "Powred by Powered-  by Discord Members discord.gg/discmembers",
                      "icon_url":
                      "https://cdn.discordapp.com/attachments/1161975044151447622/1169676279780491284/Nuovo_progetto_2.png?ex=655644ec&is=6543cfec&hm=3396618a270618a00c865cc96d6087d84805ed23f2a3d414a9cb5a7fa63910e4&"
                  }
              }]
    ...
    async def join(ctx, serverid: int = None):
      ...
      if server:
        ...
        embed.add_field(name="**Error**",
                        value="The bot is not in your server. Check out <#1197154000198451231>",
                        inline=False)
        embed.set_footer(
            text="Powered by .gg/discmembers",
            icon_url=
...
#    ) 
#    embed.set_foo- ter(text="Powered by Powered by Discord Members discord.gg/discmembers")
#    await ctx.send(embed=embed)
#
